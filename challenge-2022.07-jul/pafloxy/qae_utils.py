...
def bit_conditional( num: int, qc: QuantumCircuit, cntrl: Iterable, flip_format:bool= True): ## @helper_function
    """ helper function to assist the conditioning of ancillas 
        ...
        ----
            ...
            register : Qubits conditioned upon
        RETURNS:
        -------
    ...
    if flip_format: bin_str = bin_str[::-1]                         ## reverse the bit string
